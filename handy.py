...
if __name__ == "__main__":
    ...
    # Valores iniciales de HSV
    cv2.setTrackbarPos('HMin', 'HSV Adjustments', 0)
    cv2.setTrackbarPos('HMax', 'HSV Adjustments', 178)
    cv2.setTrackbarPos('SMin', 'HSV Adjustments', 0)
    cv2.setTrackbarPos('SMax', 'HSV Adjustments', 255)
    cv2.setTrackbarPos('VMin', 'HSV Adjustments', 0)
    cv2.setTrackbarPos('VMax', 'HSV Adjustments', 103)
    ...
    while cap.isOpened():
        ...
        # Obtener valores actuales de las trackbars
        ...
        # Actualizar los valores de HSV en tiempo real
